...
/**
 * 32    * Demonstrates a workaround you can use to generate large workbooks and avoid OutOfMemory exception. 33    * 34
 * * The trick is as follows: 35    * 1. create a template workbook, create sheets and global objects such as cell
 * styles, number formats, etc. 36    * 2. create an application that streams data in a text file 37    * 3. Substitute
 * the sheet in the template with the generated data 38    * 39    * @author Yegor Kozlov 40
 */
public class BigGridDemo {
    ...
    /**
     * Writes spreadsheet data in a Writer. (YK: in future it may evolve in a full-featured API for streaming data in
     * Excel)
     */
